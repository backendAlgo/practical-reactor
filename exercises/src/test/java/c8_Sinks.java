...
public class c8_Sinks extends SinksBase {
    ...
    public void single_shooter() {
        ...
        submitOperation(() -> {
            ...
            sink.emitValue(true, (signalType, emitResult) -> false);
        });
    ...
    public void multipleSubscribers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        flux.subscribe(num -> System.out.println("first subs" + num));
        flux.subscribe(num -> System.out.println("second subs" + num));
        flux.subscribe(num -> System.out.println("third subs" + num));
        sink.tryEmitNext(10);
        sink.tryEmitComplete();
        Thread.sleep(5000);
    }
    ...
    public void it_gets_crowded() {
        ...
        submitOperation(() -> {
            List<Integer> measures_readings = get_measures_readings(); //don't change this line
            measures_readings.forEach(message -> sink.tryEmitNext(message));
        });
